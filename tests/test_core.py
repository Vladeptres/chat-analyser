...
from chat_analyser.api.models import ConversationAnalysisResponse, UserFeedback
...
class TestAnalyser(unittest.TestCase):
    def setUp(self):
        ...
        self.sample_context_content = "# Test Context\nThis is a test context for analysis."
        self.sample_markdown_output = "<h1>Test Context</h1>\n<p>This is a test context for analysis.</p>"
    ...
    def test_load_context_invalid_type(self):
        ...
        self.assertIn("Context type invalid_context not among existing context", str(context.exception))
    ...
    def test_analyse_chat_success(self, mock_format_query, mock_client):
        ...
        mock_format_query.assert_called_once_with("party", self.sample_messages, self.sample_users)
    ...
    def test_analyse_chat_with_custom_model(self, mock_format_query, mock_client):
        ...
        analyse_chat("party", self.sample_messages, self.sample_users, model=custom_model)
...
class TestUtils(unittest.TestCase):
    ...
    def test_write_context_success(self, mock_contexts_dir):
        ...
        with patch('chat_analyser.core.utils.pjoin', return_value=os.path.join(self.test_dir, "test_context.md")):
